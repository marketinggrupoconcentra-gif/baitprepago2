...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    detail: 'Intelix rechazó la autenticación del servicio. No se reintenta: revisa INTELIX_API_KEY en Configuración › Integraciones y libera el lead manualmente.',
    retryable: false,
  },
  {
    test: (c) =>
